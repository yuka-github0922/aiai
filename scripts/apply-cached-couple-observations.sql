-- 手動適用用（supabase/migrations/20260525110000_cached_couple_observations.sql と同内容）
--
-- ※ get_cached_couple_traits の戻り型が変わるため、必ず DROP から実行する。
--   全体が失敗する場合は、下の 1 行だけ先に実行してから残りを流す。
