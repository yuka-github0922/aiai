-- Dev/test: seed_couple_home_world_test_data RPC
-- 実行: node scripts/run-seed-home-world-test.mjs
...
BEGIN
  ...
  INSERT INTO daily_question_rounds (
    couple_id, question_id, sequence_number, started_at, round_date, revealed_at
  )
  VALUES (
    v_couple_id,
