...
export default function DashboardHero({
  ...
  return (
    <section className="aiai-sticker-card overflow-hidden">
      {hasPartner ? (
        <>
          <div className="aiai-arch-window bg-gradient-to-br from-rose-100/95 via-orange-50/90 to-sky-100/85 px-5 pt-7 pb-5 relative">
            ...
            <p className="text-center text-[10px] text-rose-400/90 mt-5 tracking-wide">
              今日も、ふたりのことを大切に
            </p>
            ...
            <h1 className="text-center text-base font-bold text-gray-800 mt-2 leading-snug">
              ...
              <span className="text-rose-400 mx-2 text-sm">♥</span>
            ...
            {stats.daysTogether !== null && (
              <p className="text-center mt-4 leading-none">
                ...
                <span className="text-sm font-bold text-rose-400/80 ml-1">日目</span>
              </p>
            )}

            <span
              className="absolute bottom-3 right-5 text-rose-200/60 text-2xl pointer-events-none select-none"
              aria-hidden="true"
            >
              ♥
            </span>
