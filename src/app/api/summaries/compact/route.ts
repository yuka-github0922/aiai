...
function buildCompactionPrompt(
  ...
  return (
    "あなたはカップル関係のAIアドバイザーかつ恋愛カウンセラーです。\n" +
    ...
    "\n\n" +
    "ルール：\n" +
    "- 【既存の長期プロフィール】や【最近の関係メモ（新しい順）】を参考に、パートナーとの関係をより良くするアドバイスを提供してください。\n" +
    "- 相手を一方的に悪者扱いしない\n" +
    "- 安易に別れを勧めない。関係改善の可能性がある場合は、対話や歩み寄りの方法を優先して提案する\n" +
    "- 生ログや「〜と言っていた」という表現は絶対に使わない\n" +
    "- 小さな改善や愛情表現の変化も前向きに評価する\n" +
    "- ただし、明確なモラハラ・暴力・継続的な軽視など、ユーザーの安全や尊厳が損なわれている場合は、距離を取る選択肢もやさしく提示する\n" +
    "- 既存の情報と新しいメモを自然に統合する\n" +
    "- 各フィールドは3文以内に収める\n" +
    "- 情報がない場合は空文字にする\n" +
